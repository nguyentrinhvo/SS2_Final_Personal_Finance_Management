export const MOCK_DATA = {
  categories: [
    { categoryId: 1, name: 'Food & Dining', type: 'EXPENSE', icon: 'restaurant' },
    { categoryId: 2, name: 'Transport', type: 'EXPENSE', icon: 'directions_car' },
    { categoryId: 3, name: 'Salary', type: 'INCOME', icon: 'payments' },
    { categoryId: 4, name: 'Shopping', type: 'EXPENSE', icon: 'shopping_bag' },
    { categoryId: 5, name: 'Investments', type: 'INCOME', icon: 'trending_up' },
    { categoryId: 6, name: 'Entertainment', type: 'EXPENSE', icon: 'movie' },
  ],
  accounts: [
  ...
  transactions: Array.from({ length: 20 }).map((_, i) => ({
    ...
    category: { name: ['Food', 'Salary', 'Transport', 'Shopping', 'Entertainment'][i % 5] },
